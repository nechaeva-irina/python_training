    ...
    def get_contact_list(self):
        ...
        try:
            ...
            for row in cursor:
                ...
                list.append(
                Contact(id=str(id), firstname=firstname, lastname=lastname, company_address=address, homephone=home,
                        mobilephone=mobile, workphone=work, homephone2=phone2, email1=email, email2=email2,
                        email3=email3))
        finally:
            cursor.close()
        return list
